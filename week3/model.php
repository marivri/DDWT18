...
/**
 * Sets the HTTP Header to a given content type
 * @param $content_type
 */
...
/**
 * Evaluates username and password against the array of credentials
 * @param $cred
 * @return bool only returns True if both password & user are correct
 */
